...
const SLIDES = [{"accent": "#a855f7", "icon": "\ud83d\udcd3", "title": "Write freely.\nStore privately.", "desc": "CipherNote encrypts every entry with AES-256. Your thoughts are yours alone \u2014 no one else can read them."}, {"accent": "#9333ea", "icon": "\ud83d\udd12", "title": "PIN-locked.\nCrash-proof.", "desc": "Open your journal with a PIN. Auto-locks when you step away. Your privacy is always protected."}, {"accent": "#7e22ce", "icon": "\ud83d\ude0a", "title": "Track your moods.\nUnderstand yourself.", "desc": "Tag entries with moods and see patterns over time. A private emotional record that helps you grow."}];
